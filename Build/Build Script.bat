...
devenv ..\LCARSmain\LCARSmain.sln /Build "Release|AnyCPU" > nul && echo Main project compile succeeded.
...
devenv "..\Standard Installer\Standard Installer.sln" /Build "Release|AnyCPU" > nul && echo Compile Complete.
echo Linking files
