...
#Region " Global Variables "
    ...
    Public inRedAlert As LCARS.LCARSalert = LCARSalert.Normal
...
#Region " Properties "
   ...
   Public Property AutoEllipsis() As Boolean
    ...
    Public Property RedAlert() As LCARS.LCARSalert
        Get
            Return inRedAlert
        End Get
...
Public Class UI
    ...
    Private Shared Sub shows(ByVal prompt As Object, ByVal buttons As Microsoft.VisualBasic.MsgBoxStyle, ByVal title As String)
        ...
        elberr1.ElbowStyle = LCARS.Controls.Elbow.LCARSelbowStyles.UpperRight
        ...
        elberr2.ElbowStyle = LCARS.Controls.Elbow.LCARSelbowStyles.LowerRight
